...
@AndroidEntryPoint
public class ActivityPageActivity extends BaseActivity implements View.OnClickListener, ActivityDataInteract {
    ...
    public void onResume()
    {
        ...
        if (viewModel == null)
        {
            ((HomeActivity)getApplicationContext()).resetFragment(WalletPage.ACTIVITY);
        }
        else
        {
            viewModel.prepare();
